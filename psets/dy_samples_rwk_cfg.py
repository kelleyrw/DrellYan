...
process.dy_samples = cms.VPSet(
	cms.PSet(
		...
		ntuple_path = cms.string(data_path+ "/Single*_Run2012A-recover-06Aug2012-v1_AOD.root"),
	...
	cms.PSet(
		...
		ntuple_path = cms.string(mc_path + "/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/TTJets_FullLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v2.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/TTJets_SemiLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/QCD_Pt_20_MuEnrichedPt_15_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v3.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/WWJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/WZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/ZZJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v3.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path = cms.string(mc_path + "/ZZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
    ...
    cms.PSet(
    	...
    	ntuple_path =cms.string(mc_path + "/ZZJetsTo4L_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1.root"),
